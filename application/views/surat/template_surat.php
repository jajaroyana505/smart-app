...
<body>
    <div class="container" style=" width: 600px ;">
        ...
        <div class="text-center mt-5">
            <div class="fs-5 fw-bold"><u>SURAT PENGANTAR</u></div>
            <p>Nomor : <?= $no_surat ?></p>
        </div>
        ...
        <div class="fs-6 text-align-center" style="text-align:justify ;">
            <p>&emsp; &emsp; Nama tersebut adalah benar-benar warga kami. Demikan surat pengantar ini kami berikan guna proses tindank lanjut ke ke tingkat selanjutnya.
            </p>
