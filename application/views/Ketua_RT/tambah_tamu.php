<div class="card p-3">
    <div class="card-header py-3 m-3 bg-success text-white text-center ">
        <h6 class="m-0 font-weight-bold">Tambah Tamu</h6>
    </div>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            <div class="form-group">
                <input type="text" class="form-control" id="" name="" placeholder="Nama Tamu">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" id="" name="" placeholder="Tanggal">
            </div>
            <div class="form-group">
            ...
            <div class="mb-3">
                ...
                <input class="form-control pb-5 pt-3" type="file" id="formFile">
            </div>
        </div>
